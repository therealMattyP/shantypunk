"""
SHANTYPUNK MODULAR STOCKYARD GENERATOR v1.8
======================================

Creates an expansion-ready stock, assembly, and placeholder-socket library for Blender and Unreal.
...
UV generation is intentionally deferred.
...
def main():
    ...
    print("v1.8: corrected foundational local-space cube and cylinder pivots.")
